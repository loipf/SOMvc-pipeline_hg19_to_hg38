...
process BAM_TO_FASTQ_PREPROCESS { 
	...
	samtools collate -O -u -@ !{num_threads} !{bam_file} collate_subset | samtools fastq -@ !{num_threads} -1 !{sample_id}_reads_1.fastq -2 !{sample_id}_reads_2.fastq -0 /dev/null -s /dev/null -n -
